...
import (
	...
	"github.com/xlt-evil/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/domain/request"
	"github.com/xlt-evil/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/domain/response"
)
