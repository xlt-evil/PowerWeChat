...
import (
	...
	"github.com/xlt-evil/PowerWeChat/v3/src/officialAccount/broadcasting/request"
	"github.com/xlt-evil/PowerWeChat/v3/src/officialAccount/broadcasting/response"
)
