...
import (
	...
	"github.com/xlt-evil/PowerWeChat/v3/src/officialAccount/customerService/request"
	"github.com/xlt-evil/PowerWeChat/v3/src/officialAccount/customerService/response"
)
