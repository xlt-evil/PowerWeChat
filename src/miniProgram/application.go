...
import (
	...
	"github.com/xlt-evil/PowerWeChat/v3/src/basicService/subscribeMessage"
	...
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/b2b"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/base"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/customerServiceMessage"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/dataCube"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/device"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/express"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/image"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/immediateDelivery"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/industry/miniDrama/vod"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/internet"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/liveBroadcast"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/nearbyPoi"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/ocr"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/operation"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/phoneNumber"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/plugin"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/riskControl"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/search"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/security"
	server2 "github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/server"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/serviceMarket"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/shortLink"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/soter"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/uniformMessage"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/updatableMessage"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/urlLink"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/urlScheme"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/virtualPayment"
	wxaSecOrder "github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/wxa/sec/order"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/wxaCode"
	"github.com/xlt-evil/PowerWeChat/v3/src/officialAccount/server"
	"net/http"
)
