...
import (
	...
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/updatableMessage/request"
	"github.com/xlt-evil/PowerWeChat/v3/src/miniProgram/updatableMessage/response"
)
